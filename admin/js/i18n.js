...
const STRINGS = {
  en: {
    ...
    "nf.hint": "Search for existing profiles and add them here — everyone you add will be linked together as one family on the kiosk. Adding someone who's already in a family brings their whole family along, so you can drop individuals straight into it.",
    "nf.members": "Family members",
    "nf.searchPh": "Search by name or kaimyo…",
    "nf.save": "Create family",
    "nf.needTwo": "Add at least two people to create a family.",
    "nf.saving": "Linking family…",
    "nf.created": "Family created — {n} people linked.",
  ...
  ja: {
    ...
    "nf.title": "ご家族を作成",
    "nf.hint": "既存のプロフィールを検索して追加してください — 追加した方々はキオスク上でひとつのご家族として連携されます。すでにご家族に登録されている方を追加すると、そのご家族全員も一緒に追加されるので、個人をそのまま加えることができます。",
    "nf.members": "ご家族",
    "nf.searchPh": "名前・戒名で検索…",
    "nf.save": "ご家族を作成",
    "nf.needTwo": "ご家族を作成するには2名以上追加してください。",
    "nf.saving": "ご家族を連携中…",
    "nf.created": "ご家族を作成しました — {n}名を連携しました。",
